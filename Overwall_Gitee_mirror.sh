...
sed -i 's#https://cdn.jsdelivr.net/gh/yIwIoTT9A21nupT/2aXGmlWs/KkFCtZkeAP/avtPeqDKt645Arm#https://raw.githubusercontent.com/icecoke1024/overwall_backup/master/KkFCtZkeAP/avtPeqDKt645Arm#g' ${root}/update
...
sed -i 's#https://cdn.jsdelivr.net/gh/fangxx3863/overwall_list/GFW_List#https://raw.githubusercontent.com/icecoke1024/overwall_backup/master/KkFCtZkeAP/avtPeqDKt645Arm#g' ${root}/update
...
sed -i 's#https://github.com/icecoke1024/overwall_backup/tree/master/KkFCtZkeAP#https://github.com/icecoke1024/overwall_backup/tree/master/KkFCtZkeAP#g' ${root}/preload
# NF
